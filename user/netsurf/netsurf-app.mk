...
INC = -I$(NS) -I$(NS)/include -I$(NS)/content/handlers -I$(NS)/frontends \
      -I$(HERE)compat -I$(HERE)gen -I$(HERE)gen/duktape -I$(OUT) -I$(ZUSER) -I$(ZKINC) \
...
# --- JavaScript: Duktape backend (DOM bindings generated by nsgenbind) ------------------
# The ~200 binding sources are pre-generated into gen/duktape/ (committed, like our other
# gen/ files); their authoritative compile list is NSGENBIND_SOURCES, from the generated
# Makefile fragment. Regenerate with third_party/nsgenbind on the .bnd / WebIDL inputs.
include $(HERE)gen/duktape/Makefile
JSDUK      := $(NS)/content/handlers/javascript/duktape
JS_DUK_SRC := $(JSDUK)/dukky.c $(JSDUK)/duktape.c \
              $(addprefix $(HERE)gen/duktape/,$(NSGENBIND_SOURCES))
