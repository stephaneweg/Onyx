...
//   ftpfs_login ("ftp.example.com", "me", "secret")  -> 1 if delivered (C and C++)
// Used by the File Viewer's Connect dialog and /bin/ftp. (Protocol: service "ftpfs",
// message type 1 = "host\0user\0pass\0", see user/bin/ftpfs.cpp.)
//
#ifndef _ftpfs_h
#define _ftpfs_h
...
static inline int ftpfs_login (const char *host, const char *user, const char *pass)
{
	...
	return kapi_mailbox_send (pid, 1, msg, (unsigned) n) != 0;
}
