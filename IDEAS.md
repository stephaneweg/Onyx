...
| P2b | **Apps plein écran** | `fullscreen_begin` : l'app reçoit un tampon plein écran mappé chez elle, `present_fb` l'affiche ; pendant ce temps le compositeur ne dessine plus les fenêtres ; `fullscreen_end` / sortie de l'app rend le bureau. | 💡 |
