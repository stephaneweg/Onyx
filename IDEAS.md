...
| Port audio : synth FM + tracker | 🔨 | **Base faite** : sortie PWM (jack), producteur sur le cœur 1, kapi v46 (16 voix square/sine/triangle/saw/noise + flux PCM, propriétaire exclusif), BASIC `PLAY`/`SOUND`/`NOTEON`. Reste : Amener le synth FM + tracker dans Onyx. Fixed-point + PWM. |
